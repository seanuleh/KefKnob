...
//   [2] arc 280×280
//   [3] vol label + play icon
//   [4] title + artist + hint labels
//   [5] control panel overlay (hidden until swipe-from-top)
//
// Text layout:
//   CENTER, -20, -20  → vol number  (Montserrat 30)
//   CENTER, +18, -20  → play icon   (Montserrat 20, right of vol)
//   CENTER,   0, +20  → title       (Montserrat 20, scroll)
//   CENTER,   0, +50  → artist      (Montserrat 16, scroll)
//   BOTTOM_MID, 0,-15 → hint        (Montserrat 12)
// ---------------------------------------------------------------------------
...
void main_screen_create() {
    ...
    lv_obj_set_style_text_font(s_vol_label, &lv_font_montserrat_30, 0);
    lv_obj_set_style_text_color(s_vol_label, lv_color_hex(0xFFFFFF), 0);
    lv_label_set_text(s_vol_label, "50");
    lv_obj_align(s_vol_label, LV_ALIGN_CENTER, -20, -20);

    // ---- [4] Play/pause icon (right of vol) ----
    s_play_icon = lv_label_create(s_screen);
    lv_obj_set_style_text_font(s_play_icon, &lv_font_montserrat_20, 0);
    lv_obj_set_style_text_color(s_play_icon, lv_color_hex(0x00BFFF), 0);
    lv_label_set_text(s_play_icon, LV_SYMBOL_PLAY);
    lv_obj_align_to(s_play_icon, s_vol_label, LV_ALIGN_OUT_RIGHT_MID, 8, 0);
    ...
    // Dark pill background + shadow for legibility over album art
    lv_obj_set_style_bg_color(s_title_label, lv_color_hex(0x000000), 0);
    lv_obj_set_style_bg_opa(s_title_label, LV_OPA_40, 0);
    lv_obj_set_style_radius(s_title_label, 5, 0);
    lv_obj_set_style_pad_hor(s_title_label, 8, 0);
    lv_obj_set_style_pad_ver(s_title_label, 4, 0);
    lv_obj_set_style_shadow_color(s_title_label, lv_color_hex(0x000000), 0);
    lv_obj_set_style_shadow_width(s_title_label, 16, 0);
    lv_obj_set_style_shadow_spread(s_title_label, 4, 0);
    lv_obj_set_style_shadow_opa(s_title_label, LV_OPA_90, 0);
    ...
    lv_obj_set_style_text_color(s_artist_label, lv_color_hex(0xDDDDDD), 0);
    ...
    lv_obj_align(s_artist_label, LV_ALIGN_CENTER, 0, 50);
    // Same dark pill background + shadow
    lv_obj_set_style_bg_color(s_artist_label, lv_color_hex(0x000000), 0);
    lv_obj_set_style_bg_opa(s_artist_label, LV_OPA_40, 0);
    lv_obj_set_style_radius(s_artist_label, 5, 0);
    lv_obj_set_style_pad_hor(s_artist_label, 8, 0);
    lv_obj_set_style_pad_ver(s_artist_label, 3, 0);
    lv_obj_set_style_shadow_color(s_artist_label, lv_color_hex(0x000000), 0);
    lv_obj_set_style_shadow_width(s_artist_label, 14, 0);
    lv_obj_set_style_shadow_spread(s_artist_label, 3, 0);
    lv_obj_set_style_shadow_opa(s_artist_label, LV_OPA_90, 0);
    ...
    lv_obj_set_style_text_color(s_hint_label, lv_color_hex(0x333333), 0);
    lv_label_set_text(s_hint_label, LV_SYMBOL_LEFT " swipe " LV_SYMBOL_RIGHT);
    lv_obj_align(s_hint_label, LV_ALIGN_BOTTOM_MID, 0, -15);

    // ---- [5] Control panel — dark overlay, swipe-from-top to reveal ----
...
void main_screen_update(int volume, const char *title,
    ...
    lv_obj_align_to(s_play_icon, s_vol_label, LV_ALIGN_OUT_RIGHT_MID, 8, 0);
    lv_label_set_text(s_play_icon, is_playing ? LV_SYMBOL_PAUSE : LV_SYMBOL_PLAY);
